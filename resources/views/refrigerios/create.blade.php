...
<div class="py-6">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">➕ Nuevo Refrigerio</h1>
                <p class="text-gray-600 mt-1">Registra un nuevo refrigerio en el sistema</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                <form action="{{ route('refrigerios.store') }}" method="POST">
                    @csrf

                ...
                <form action="{{ route('servicios.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            maxlength="10"
                            pattern="[A-Z0-9]+"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition uppercase"
                            style="text-transform: uppercase;"
                            required
                        >
                        <p class="text-sm text-gray-500 mt-1">Este prefijo se usará para generar los códigos de las camas (ej: CE1, CE2, CE3...)</p>
                        @error('prefijo')
                            <div class="text-red-600 text-sm mt-2 flex items-center gap-1">
                                <span>⚠️</span>
                                <span>{{ $message }}</span>

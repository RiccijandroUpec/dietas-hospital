                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('registro-refrigerios.show', $base) }}" class="inline-flex items-center px-3 py-1 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-md transition duration-200 font-medium">
                                        ...
                                        @if(auth()->user()->role !== 'usuario')
                                            <a href="{{ route('registro-refrigerios.edit', $base) }}" class="inline-flex items-center px-3 py-1 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-md transition duration-200 font-medium">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @if(auth()->user()->role === 'admin')
                                            <form action="{{ route('registro-refrigerios.destroy', $base) }}" method="POST" class="inline" onsubmit="return confirm('Eliminar registro?')">
                                                @csrf @method('DELETE')
                                                <button style="color: white !important;" class="inline-flex items-center px-3 py-1 bg-red-600 text-white hover:bg-red-700 rounded-md transition duration-200 font-medium">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="md:hidden space-y-4">
            @forelse($grupos as $clave => $items)
                ...
                <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-orange-500">
                    ...
                    <!-- Acciones -->
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('registro-refrigerios.show', $base) }}" class="flex-1 inline-flex items-center justify-center px-3 py-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-md transition duration-200 font-medium text-sm">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                            </svg>
                        ...
                        @if(auth()->user()->role !== 'usuario')
                            <a href="{{ route('registro-refrigerios.edit', $base) }}" class="flex-1 inline-flex items-center justify-center px-3 py-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 rounded-md transition duration-200 font-medium text-sm">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                                Editar
                        ...
                        @if(auth()->user()->role === 'admin')
                            <form action="{{ route('registro-refrigerios.destroy', $base) }}" method="POST" class="flex-1" onsubmit="return confirm('¿Eliminar registro?')">
                                @csrf @method('DELETE')
                                <button style="color: white !important;" class="w-full inline-flex items-center justify-center px-3 py-2 bg-red-600 text-white hover:bg-red-700 rounded-md transition duration-200 font-medium text-sm">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                    </svg>
                                    Eliminar

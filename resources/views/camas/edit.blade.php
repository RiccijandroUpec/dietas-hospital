    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="font-semibold text-xl text-gray-800 mb-4">Editar Cama</h2>
                ...
                <form action="{{ route('camas.update', $cama) }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" name="codigo" value="{{ old('codigo', $cama->codigo) }}" class="mt-1 block w-full border-gray-300 rounded-md">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="servicio_id" class="mt-1 block w-full border-gray-300 rounded-md">
                            ...
                            @foreach($servicios as $servicio)
                                <option value="{{ $servicio->id }}" @if(old('servicio_id', $cama->servicio_id) == $servicio->id) selected @endif>{{ $servicio->nombre }}</option>
                            @endforeach
                        </select>
